...
func (s *Server) connectHandoffPage(w http.ResponseWriter, r *http.Request) {
	...
	_ = connectPageTemplate.Execute(w, map[string]any{
		...
		"Launch": "/connect/" + r.PathValue("token") + "/launch",
	})
}
