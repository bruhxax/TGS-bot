...
var DefaultSettings = map[string]map[string]any{
	"content": {
		...
		"connect_install_title": "Установка приложения", "connect_install_hint": "Скачайте клиент для своего устройства и установите приложение.", "connect_add_title": "Добавление подписки", "connect_add_hint": "Откроется браузер и предложит передать подписку выбранному приложению.", "connect_use_title": "Подключение и использование", "connect_use_hint": "Откройте приложение, выберите сервер и нажмите кнопку подключения.", "connect_qr_title": "QR-код подписки",
