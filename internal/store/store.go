...
const defaultPrivacyPolicy = `Дата вступления в силу — {effective_date}
...
const defaultUserAgreement = `Дата вступления в силу — {effective_date}
...
var DefaultSettings = map[string]map[string]any{
	"content": {
		...
		"legal_effective_date": "13 сентября 2026 г.", "legal_support": "@bruhvpnsupport", "privacy_policy_text": defaultPrivacyPolicy, "user_agreement_text": defaultUserAgreement,
	...
	"language":   {"default": "ru"},
	"more_order": {"items": []any{"servers", "devices", "payments", "referral", "privacy", "agreement"}},
